...
namespace MyHobbyPal.Client
{
    ...
    public partial class AddHobbyForPersonInputSerializer
        : IInputSerializer
    {
        ...
        public string Name { get; } = "AddHobbyForPersonInput";

        public ValueKind Kind { get; } = ValueKind.InputObject;

        public Type ClrType => typeof(AddHobbyForPersonInput);
        ...
        public object Serialize(object value)
        {
            ...
            var input = (AddHobbyForPersonInput)value;
