...
{
    public static class MyHobbyPalClientServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddMyHobbyPalClient(
            this IServiceCollection serviceCollection)
        {
            if (serviceCollection is null)
            {
        ...
        private static IServiceCollection AddResultParsers(
            this IServiceCollection serviceCollection)
        {
            serviceCollection.AddSingleton<IResultParser, GetAllPersonsResultParser>();
            return serviceCollection;
        }
        ...
        private static Func<HttpClient> ClientFactory(IServiceProvider services)
        {
            ...
            return () => clientFactory.CreateClient("MyHobbyPalClient");
        }
